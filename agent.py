    ...
    def choose_action(self, state):
        ...
        if(not self.learning):
            ...
            if(random.random() < self.epsilon):
                ...
                maxKeys = [k for k, v in self.Q[state].items() if v == maxQ]   # Get the key(s) with maximum Q values (rewards).
                action = maxKeys[random.randint(0, len(maxKeys) - 1)]          # Select randomly one of the keys with maximum Q values.
        return action
